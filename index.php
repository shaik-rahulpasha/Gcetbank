		...
		<div id="banner-image">
			<div class="container">
				<div id="banner_content">
					<h1>Welcome to GcetBank</h1>
					<p>Donate money for oxygen cylinders</p>
					<a href="Donate.php">
						<button class="btn btn-danger btn-lg active">Donate</button>
					</a>
				</div>
			</div>
		</div>
          ...
          <div class='row'>
              ...
              <div class='col-sm-4'>
                ...
                <a href='#' class='thumbnail'><img src='https://media.gettyimages.com/photos/stressed-young-woman-checking-bills-taxes-bank-account-balance-and-picture-id1168727839?s=2048x2048' alt='pic'>
                </a><div class="caption">
               ...
               <div class='col-sm-4'>
                   <div class='thumbnail'>
                   <a href='#'class='thumbnail' ><img src='https://tse2.mm.bing.net/th?id=OIP.WPi0Hy6tMbxcgNff2Cz5KwHaEK&pid=Api&P=0&w=294&h=167' alt='pic'>  </a>
                     <div class="caption">
                         <h4>Money Deposit</h4>
